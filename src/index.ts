...
export type BoundIconArg =
  | IconDefinition
  | IconName
  | Array<IconName | IconPrefix>;
...
export function configure(
  ...
  if (options && options.icons && options.icons.length !== 0) {
    ...
    LogManager.getLogger("aurelia-fontawesome").warn(
      'No icons loaded. You must use "Explicit Loading" or call use ' +
